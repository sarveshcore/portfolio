...
const Links = () => {
  const svgs: { path: string; href: string }[] = [
    {
    ...
    <div className="absolute bottom-10 right-10 flex space-x-6">
      {svgs.map(({ path, href }) => (
        <a
          key={href}
          href={href}
          className="text-white hover:text-[#CC0000] transition-colors duration-300"
        >
          <svg
            ...
            height="32"
            viewBox="0 0 256 256"
            className="fill-white w-12 h-12 hover:fill-red-600 transition duration-300"
          >
            <path d={path}></path>
          </svg>
        </a>
